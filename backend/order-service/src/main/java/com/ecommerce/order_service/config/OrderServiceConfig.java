...
public class OrderServiceConfig {
    ...
    public ConsumerFactory<String, PaymentResponseDto> paymentResponseConsumerFactory() {
        JsonDeserializer<PaymentResponseDto> deserializer = new JsonDeserializer<>(PaymentResponseDto.class, false);
        deserializer.addTrustedPackages("com.ecommerce.order_service.payload");
